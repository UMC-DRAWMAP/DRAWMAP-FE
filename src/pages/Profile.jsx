			...
			<div className="pf-my-page">
				...
				<div className="pf-mp-group">
					<div className="pf-mp-left">
						<DefaultImg className="mp-img" style={{ display: 'block', width: '125.878px', height: '136.368px' }} />
						<img
							className="mp-img"
							src="https://m.lovecoco.co.kr/web/product/big/20200212/7b5253e2894d678cc34a315959ee8e2d.jpg"
							alt="프로필 이미지"
							style={{ display: 'none' }}
						/>
					</div>
