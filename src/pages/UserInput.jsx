		...
		<div className="UserInput">
			...
			<div className="inputcontainer">
				...
				<div className="detailinputcontainer">
					...
					<p className="inputitem" style={{ marginTop: '30px' }}>
						생년월일
					</p>
					<input type="text" className="detailinput" />
				</div>
				<div className="regioninputcontainer" style={{ marginLeft: '20px', marginTop: '30px' }}>
					...
					<button className="regionbutton" style={{ backgroundColor: `var(${isClicked1})` }} onClick={handleClick1}>
						서울
					</button>
					<button className="regionbutton" style={{ backgroundColor: `var(${isClicked2})` }} onClick={handleClick2}>
						경기
					</button>
					<button className="regionbutton" style={{ backgroundColor: `var(${isClicked3})` }} onClick={handleClick3}>
						인천
					</button>
					<button className="regionbutton" style={{ backgroundColor: `var(${isClicked4})` }} onClick={handleClick4}>
						강원
					</button>
					<button className="regionbutton" style={{ backgroundColor: `var(${isClicked5})` }} onClick={handleClick5}>
						대전
					</button>
				</div>
				<div className="regioninputcontainer" style={{ marginLeft: '20px', marginTop: '10px' }}>
					<button className="regionbutton" style={{ backgroundColor: `var(${isClicked6})` }} onClick={handleClick6}>
						충청
					</button>
					<button className="regionbutton" style={{ backgroundColor: `var(${isClicked7})` }} onClick={handleClick7}>
						대구
					</button>
					<button className="regionbutton" style={{ backgroundColor: `var(${isClicked8})` }} onClick={handleClick8}>
						부산
					</button>
					<button className="regionbutton" style={{ backgroundColor: `var(${isClicked9})` }} onClick={handleClick9}>
						울산
					</button>
					<button className="regionbutton" style={{ backgroundColor: `var(${isClicked10})` }} onClick={handleClick10}>
						경상
					</button>
				</div>
				<div className="regioninputcontainer" style={{ marginLeft: '-80px', marginTop: '10px' }}>
					<button className="regionbutton" style={{ backgroundColor: `var(${isClicked11})` }} onClick={handleClick11}>
						광주
					</button>
					<button className="regionbutton" style={{ backgroundColor: `var(${isClicked12})` }} onClick={handleClick12}>
						전라
					</button>
					<button className="regionbutton" style={{ backgroundColor: `var(${isClicked13})` }} onClick={handleClick13}>
						제주
					</button>
					<button className="regionbutton" style={{ backgroundColor: `var(${isClicked14})` }} onClick={handleClick14}>
						기타
					</button>
				</div>
				...
				<div className="buttoncontainer">
					<button className="registerbutton" style={{ marginTop: '100px', marginRight: '160px' }}>
			...
			<img
				src={welcome}
				alt=""
				style={{ width: '150px', marginTop: '80px', marginBottom: '50px', marginLeft: '550px' }}
			/>
			<img src={character} alt="" style={{ width: '1286px', marginTop: '0px', marginBottom: '50px' }} />
			<Footer />
		</div>
	);
};
